...
const App: React.FC = () => {
  ...
  const processImage = useCallback(async (base64String: string, mimeType: string) => {
    setState({
      isLoading: true,
      data: null,
      error: null,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <main className="max-w-4xl mx-auto">
        ...
        {!state.imagePreview && (
          <div className="bg-white rounded-3xl shadow-sm border-4 border-dashed border-gray-200 p-8 md:p-12 transition-all hover:border-green-300">
            <input
              type="file"
              ref={fileInputRef}
            ...
            <div className="flex flex-col items-center justify-center space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500 mb-6">
                  อัปโหลด, ถ่ายรูป, หรือ <span className="inline-block bg-gray-100 text-gray-700 px-2 py-0.5 rounded text-sm font-semibold border border-gray-200">Ctrl + V</span> เพื่อวางรูปภาพ
                </p>
